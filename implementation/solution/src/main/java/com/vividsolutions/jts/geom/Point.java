 ...
 * known topological specification. Copyright (C) 2001 Vivid Solutions This
 ...
 * 02111-1307 USA For more information, contact: Vivid Solutions Suite #1A 2328
 * Government Street Victoria BC V8T 5G5 Canada (250)385-6040
...
public class Point extends Geometry implements Puntal
{
	 ...
	 * <ul>
	 * <li>the coordinate which defines it is a valid coordinate (i.e does not
	 * have an NaN X or Y ordinate)
	 * </ul>
	 * 
	...
	{
		if (!IsValidOp.isValid(getCoordinate())) return false;
		return true;
	}
