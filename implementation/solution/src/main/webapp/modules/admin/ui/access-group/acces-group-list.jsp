...
<div>
	...
	<div class="search-div">
		<form>
			<input type="text" ng-model="data.filter" class="form-control" placeholder="<spring:message code="admin.access-group.Name-or-adress"/>" style="float:left; width:300px"/>
			<input type="submit" value="<spring:message code="Search"/>" class="btn btn-default" ng-disabled="currentPage == null"
			       ng-click="listAccessGroupByFilters(data.filter, currentPage.pageable)"/>
	    </form>
	</div>
