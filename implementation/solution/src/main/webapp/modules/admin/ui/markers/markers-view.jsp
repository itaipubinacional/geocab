...
<!--Message -->
<div class="msg" style="position:absolute;text-align:center; width:57%;top:13%;left:40%; z-index:1000"
...
<div ng-switch on="currentState">
    <div ng-switch-when="marker-moderation.list">
        <div ng-include="'modules/admin/ui/markers/markers-list.jsp'"></div>
    </div>
    <div ng-switch-when="marker-moderation.detail">
        <div ng-include="'modules/admin/ui/markers/markers-detail.jsp'"></div>
    </div>
    <div ng-switch-when="marker-moderation.create">
        <div ng-include="'modules/admin/ui/markers/markers-form.jsp'"></div>
    </div>
    <div ng-switch-when="marker-moderation.update">
        <div ng-include="'modules/admin/ui/markers/markers-form.jsp'"></div>
    </div>
    <div ng-switch-when="marker-moderation.history">
        <div ng-include="'modules/admin/ui/markers/markers-history.jsp'"></div>
    </div>
