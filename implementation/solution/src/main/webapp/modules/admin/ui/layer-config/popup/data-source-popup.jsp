...
<div class="modal-content">
	...
	<div class="modal-body" ng-init="initialize();" style="overflow: visible">
        ...
        <form novalidate name="form" default-button="{{buttonInsert}}">
            ...
            <input type="submit" class="btn btn-default" style="margin-left: 5px" value="Pesquisar" ng-disabled="currentPage == null" ng-click="listDataSourceByFilters(data.filter, currentPage.pageable )"/>
        </form>
