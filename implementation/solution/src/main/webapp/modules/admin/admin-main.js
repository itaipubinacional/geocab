(function(window, angular, undefined) {
	...
	//Start the AngularJS
	var projectModule = angular.module("admin", ["ui.bootstrap", "ui.router", "ngGrid", "eits-broker", "eits-angular-translate", 'angularBootstrapNavTree', "ui.tree", 'ui-scaleSlider', 'localytics.directives', 'grid-no-result', 'eits-default-button']);
