...
<script type="text/javascript" src="<c:url value="/webjars/angular-sanitize/1.3.0-beta.18/angular-sanitize.min.js"/>"></script>
...
<!-- <script type="text/javascript" src="/static/libs/activity-dialog.js"></script> -->