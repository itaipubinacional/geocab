(function (window, angular, undefined) {
  ...
  //Start the AngularJS
  var projectModule = angular.module("map", ["ui.bootstrap", "ui.grid", "ui.grid.draggable-rows", "ui.router", "ngGrid", "eits-broker", "eits-angular-translate", "ivh.treeview", "ivh.treeview-extend", 'eits-default-button', 'localytics.directives', 'ui-scaleSlider', 'angularBootstrapNavTree', 'eits-upload-file'])
