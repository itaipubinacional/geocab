    ...
    <div class="login-wrapper">
		...
		<div class="container-login">
			...
			<table>
				...
				<tr>
					<td>
						<a style="margin: 0 0 0 100px" class="dont-have-account" 
							id="register" 
							href="${pageContext.request.contextPath != '' ? pageContext.request.contextPath: '/'}">
							<spring:message code="authentication.Show-map" />
						</a>
					</td>
				</tr>
			</table>
