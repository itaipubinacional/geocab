    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var settings = ivhTreeviewSettings.get()
                ...
                , filterAttr = attrs.ivhTreeviewFilter
                , idAttr = scope.$eval(attrs.ivhTreeviewIdAttribute) || settings.idAttribute
...
//                '<label class="ivh-treeview-toggle ivh-treeview-toggle-leaf">&#9679;</label>',
                ...
                '<label for="{{itm.' + idAttr + '.trim()}}" class="ivh-treeview-node-label dynamic-text">',
                    '<span title="{{itm.' + labelAttr + '.trim()}}" class="label-text">{{itm.' + labelAttr + '}}</span>',
                '</label>',
                '</div>',
...
angular.module('ivh.treeview').provider('ivhTreeviewSettings', function() {
    ...
    var settings = {
        ...
        /**
         * Collection item attribute to use for ids
         */
        idAttribute: 'id',
