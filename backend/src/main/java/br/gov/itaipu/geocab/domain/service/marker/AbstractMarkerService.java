...
import br.gov.itaipu.geocab.domain.repository.marker.photo.PhotoAlbumRepository;
import br.gov.itaipu.geocab.domain.repository.marker.photo.PhotoRepository;
...
import br.gov.itaipu.geocab.infrastructure.jcr.MetaFileRepository;
...
public abstract class AbstractMarkerService {
     ...
     */
    @Autowired
    protected MarkerAttributeRepository markerAttributeRepository;
    /**
     *
     */
    @Autowired
    protected MarkerModerationRepository markerModerationRepository;
    /**
     *
     */
    @Autowired
