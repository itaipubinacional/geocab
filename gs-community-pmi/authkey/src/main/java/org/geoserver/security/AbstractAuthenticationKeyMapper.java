 ...
 *
 */
public abstract class AbstractAuthenticationKeyMapper implements
	...
	protected GeoServerUserGroupService getUserGroupService()
			throws IOException {
		GeoServerUserGroupService service = getSecurityManager()
				.loadUserGroupService(getUserGroupServiceName());
		if (service == null) {
			throw new IOException("Unkown user/group service: "
	...
	// TODO é aqui que devemos alterar
	...
	/**
	 * Gets the default value for the given parameter. Default implementation
	 ...
	 */
	public void validateParameter(String paramName, String value)
