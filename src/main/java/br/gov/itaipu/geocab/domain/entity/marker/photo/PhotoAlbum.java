 ...
 *
 */
package br.gov.itaipu.geocab.domain.entity.marker.photo;
...
//	@OneToMany(cascade = CascadeType.REMOVE)
    ...
    private void generateIdentifier() {
        if (this.getMarkerAttribute() != null &&
                this.getMarkerAttribute().getMarker() != null &&
                this.getMarkerAttribute().getMarker().getId() != null) {
    ...
    /**
     * @param markerAttribute the markerAttribute to set
     */
