...
public class UserSocialConnection
        ...
        implements br.gov.itaipu.geocab.domain.entity.Entity<Long> {
    /**
     *
     */
     ...
     *-------------------------------------------------------------------*/
    /* (non-Javadoc)
	 * @see br.com.eits.prize.global.domain.entity.Entity#getId()
	 */
    @Override
    public Long getId() {
        return this.id;
    ...
    /* (non-Javadoc)
     * @see br.com.eits.prize.global.domain.entity.Entity#setId(java.io.Serializable)
     */
    @Override
